...
## [`.mcworld`](https://edusupport.minecraft.net/hc/en-us/articles/360047555391-Import-Export-and-Manage-Worlds) は何でできているのか 📦
...
| [ビヘイビアーパック](https://learn.microsoft.com/minecraft/creator/documents/behaviorpackfromscratch?view=minecraft-bedrock-stable) | Minecraft Bedrock のゲーム内動作を追加する仕組み |
| [mcfunction](https://learn.microsoft.com/minecraft/creator/documents/functionsintroduction?view=minecraft-bedrock-stable) | Minecraft のコマンドをまとめて書いておくファイル |
...
| `build/lib/protection.py` | 外周のバリアや [`deny` ブロック](https://edusupport.minecraft.net/hc/en-us/articles/360047116852-Specialty-Blocks-Allow-Deny-Border-Structure)を配置し、展示ワールドとして壊れにくくする |
...
## ゲームの動きは[ビヘイビアーパック](https://learn.microsoft.com/minecraft/creator/documents/behaviorpackfromscratch?view=minecraft-bedrock-stable)で作る ⚙️
...
[`mcfunction`](https://learn.microsoft.com/minecraft/creator/documents/functionsintroduction?view=minecraft-bedrock-stable) は、Minecraft のコマンドをまとめて書いておくファイルです。
...
ここでは [`scoreboard`](https://learn.microsoft.com/minecraft/creator/reference/content/commandsreference/examples/commands/scoreboard?view=minecraft-bedrock-stable) という Minecraft の仕組みを使って、プレイヤーごとの状態を保存しています。
...
## [NPC 会話](https://learn.microsoft.com/minecraft/creator/documents/npcdialogue?view=minecraft-bedrock-stable)は JSON で作る 💬

店員 NPC の「ニンニク入れますか？」の画面は、`dialogue/jiro_call.json` で作っています。

[`dialogue`](https://learn.microsoft.com/minecraft/creator/commands/commands/dialogue?view=minecraft-bedrock-stable) は NPC の会話画面を定義するファイルです。
...
近くのプレイヤーを意味する [`@p` などのターゲットセレクター](https://learn.microsoft.com/minecraft/creator/documents/targetselectors?view=minecraft-bedrock-stable)で書くと、複数人で遊んだときに別の人へ処理が飛ぶ可能性があります。
